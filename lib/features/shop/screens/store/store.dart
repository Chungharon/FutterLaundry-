              ...
              flexibleSpace: Padding(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    const TSearchContainer(text: 'Search Service', showBorder: true, showBackground: false, padding: EdgeInsets.zero),
                    const SizedBox(height: TSizes.spaceBtwSection),


                    /// -- Freatured Clothing Service
                    TSectionHeading(title: 'Featured Cloth Service', onPressed: () {}),
                    const SizedBox(height: TSizes.spaceBtwItems / 1.5),

                    TGridLayout(
                      itemCount: 4, mainAxiExtent: 80,
                      itemBuilder: (_, index) {

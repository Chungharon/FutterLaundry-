...
class TSingleAddress extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TRoundedContainer(
      ...
      // CORRECTED LINE: Used .toInt() to explicitly convert the double to an int
      backgroundColor: selectedAddress ? TColors.primary.withAlpha((0.2 * 255).toInt()) : Colors.transparent,
